...
const UserProfile = () => {
  ...
  const farmerId = 'some-farmer-id'; // Replace with actual farmer ID
  ...
  const handleSaveProfile = async () => {
    try {
      await axios.put('http://localhost:8080/UpdateProfile', {...userData});
      setIsEditing(false);
      toast({
        title: "Profile updated",
        description: "Your profile information has been updated successfully.",
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="history" className="mt-6 space-y-6 animate-fadeIn">
          <Card>
            ...
            <CardContent>
              {/* Add your recommendation history logic here */}
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="settings" className="mt-6 space-y-6 animate-fadeIn">
          <Card>
            ...
            <CardContent>
              {/* Add your notification preferences logic here */}
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              {/* Add your language preferences logic here */}
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
