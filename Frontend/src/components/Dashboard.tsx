...
//   const [farmerLocation, setLocation] = useState(null);
...
//         const farmerRegion = response.data.farmer.location.region;
//         console.log('Farmer Location:', farmerRegion);  // Log structure
  
//         if (typeof farmerRegion === 'string') {
//           setLocation(farmerRegion);  
//         } else if (farmerRegion?.region) {
//           setLocation(farmerRegion.region);  // Extract 'region' string
//         }
...
//   // Log farmerInfo after state update
//   useEffect(() => {
//     if (farmerInfo) {
//       console.log("Updated farmerInfo:", farmerInfo);
//     }
//   }, [farmerInfo]);

//   // Trigger weather data fetch only after farmerLocation is set
//   useEffect(() => {
...
//           params: { location: farmerLocation }
//         });
//         console.log("response", response);

//         console.log("response of weather", response.data.weatherData.current.temp_c);
...
//               <CardContent>
//                 <WeatherCard
//                   temperature={weatherData.data.weatherData.current.temp_c}
